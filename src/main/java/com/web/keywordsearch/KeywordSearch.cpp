#include<bits/stdc++.h>
#include <jni.h>
#include "com_web_keywordsearch_KeywordSearch.h"
using namespace std;

JNIEXPORT void JNICALL Java_com_web_keywordsearch_KeywordSearch_startKeySearch (JNIEnv *env, jobject thisObj, jstring path, jstring filename, jstring keyword) {
	...
	else 
	{
		string p1 = p;
		string fn1 = fn;
		string finalpath = p1.append(fn1);
		string k = key;
		fstream file;
