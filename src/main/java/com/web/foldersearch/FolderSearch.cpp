#include <jni.h>
#include "com_web_foldersearch_FolderSearch.h" 
#include <iostream>
#include <dirent.h>
#include <ctime>
#include <sys/stat.h>
...
void createMetaFile()
{
   ...
   string fol = "/home/harikumar_g/Documents/projects/Searching-Backend/src/main/java/com/web/foldersearch/"+foldername;
   if(files.size() > 0) {
...
JNIEXPORT jobjectArray JNICALL Java_com_web_foldersearch_FolderSearch_startSearch(JNIEnv *env, jobject thisObj,jstring path,jstring pat)
{
